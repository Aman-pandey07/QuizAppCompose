...
@Composable
fun AppDropDownMenuPreview(modifier: Modifier = Modifier) {
    val list = listOf("Nothing", "Nothing", "Nothing", "Nothing")
    AppDropDownMenu(menuName = "Nothing", menuList = list, text = "nothing", onDropDownClick = {})
}
...
//                    textColor = colorResource(id = R.color.blue_grey),
                ...
                textStyle = TextStyle(color = colorResource(id = R.color.blue_grey)),
